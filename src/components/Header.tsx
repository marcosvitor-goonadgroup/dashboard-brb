    ...
    <header className="w-full bg-[#153ece] rounded-[34px] px-8 py-6 mb-6">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-6 min-w-0">
          ...
          <div className="border-l border-white/30 pl-6 flex items-center gap-4 min-w-0">
            <img src={logobrb} alt="Banco BRB" className="h-8 w-auto shrink-0 brightness-0 invert" />
            <div className="border-l border-white/30 pl-4 min-w-0">
              <p className="text-white font-bold text-xl sm:text-2xl leading-tight whitespace-nowrap">
                Dashboard de Campanhas
              </p>
              <p className="text-white/60 text-sm whitespace-nowrap mt-0.5">
